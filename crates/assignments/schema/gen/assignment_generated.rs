...
impl<'a> ::flatbuffers::Follow<'a> for WorkerId {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { <&'a WorkerId>::follow(buf, loc) }
  }
}
impl<'a> ::flatbuffers::Follow<'a> for &'a WorkerId {
  ...
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    unsafe { ::flatbuffers::follow_cast_ref::<WorkerId>(buf, loc) }
  }
}
impl<'b> ::flatbuffers::Push for WorkerId {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const WorkerId as *const u8, <Self as ::flatbuffers::Push>::size()) };
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> ::flatbuffers::PushAlignment {
...
pub fn root_as_assignment(buf: &[u8]) -> Result<Assignment<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_assignment(buf: &[u8]) -> Result<Assignment<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_assignment_unchecked(buf: &[u8]) -> Assignment<'_> {
  unsafe { ::flatbuffers::root_unchecked::<Assignment>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_assignment_unchecked(buf: &[u8]) -> Assignment<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<Assignment>(buf) }
}
#[inline]
